...
public class Solution {
    ...
    public  static class AmigoThreadFactory implements ThreadFactory{
        ...
        public AtomicInteger currentfactoryNumber;
        public ThreadGroup threadGroup;

        public AmigoThreadFactory()
        {
            currentfactoryNumber = new AtomicInteger(factoryNumber.incrementAndGet());
        ...
        public Thread newThread(Runnable r)
        {
            ...
            String threadName = threadGroup.getName() + "-pool-" + currentfactoryNumber + "-thread-" + threadNumber;
