...
public class Solution {
    ...
    public static class Object {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            writer.println(string1 != null ? string1.number : "null");
            writer.println(string2 != null ? string2.number : "null");
            writer.close();
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            if (!str1.equals("null")) {
                countStrings = Integer.parseInt(str1) - 1;
                string1 = new String();
            } else string1 = null;

            java.lang.String str2 = reader.readLine();
            if (!str2.equals("null")) {
                countStrings = Integer.parseInt(str2) - 1;
                string2 = new String();
            } else string2 = null;
