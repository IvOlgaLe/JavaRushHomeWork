...
public class Solution
{
    public static void main(String[] args) throws IOException
    {
        ...
        Cat catDedushka = new Cat(dedushkaName);

        String babushkaName = reader.readLine();
        Cat catBabushka = new Cat(babushkaName);

        String dadName = reader.readLine();
        Cat catDad = new Cat(dadName, catDedushka, null);

        String motherName = reader.readLine();
        Cat catMother = new Cat(motherName, null, catBabushka);
